$(function()
	{
		...
		//Cookie Upload
		$.cookie('singer_name', $("#singer_name:input").val(), { path: '/' });
		$("#singer_name:input").on('blur',function()
			{
				var singer_name=$(this).val();
				var singer_id=$('#singer_id:input').val();
				...
				var url_Send=site_url+'/admincp/singer/check_singer_name_id/';
		...
		$('#singer_url:input').on('blur',function()
			{
				...
				var urlSend=site_url+'/admincp/singer/check_singer_url_id/';
		...
		$('#submit-addsinger:button').on('click',function()
			{
				...
				var dataString=
				{
					...
					'si_id':$('#singer_id:input').val()
				};
				var urlSend=site_url+'/admincp/singer/update_singer/';
				var data=ajax_global(dataString,urlSend);
				if(data.status==true)
				{
