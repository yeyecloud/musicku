<footer id="footer-notreload" class="footer bg-dark">
    ...
    <div id="jp_container_N">
        <div class="jp-type-playlist">
                    ...
                    <div class="jp-controls">
                        ...
                        <div class="jp-progress hidden-xs">
                            <div class="jp-seek-bar dk">
                                <div class="jp-play-bar bg-dark dker">
                                </div>
            ...
            <div class="jp-no-solution hide">
                <span>
												Update Required
											</span> To play the media you will need to either update your browser to a recent version or update your
